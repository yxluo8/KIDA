...
try:
    ...
    try:
        ...
        # Fallback for newer causal-conv1d versions without cpp_functions: bind from CUDA ext
        try:
            import causal_conv1d_cuda as _causal_conv1d_cuda

            def causal_conv1d_fwd_function(x, weight, bias, *args, **kwargs):
                return _causal_conv1d_cuda.causal_conv1d_fwd(x, weight, bias, *args, **kwargs)

            def causal_conv1d_bwd_function(x, weight, bias, dout, *args, **kwargs):
                return _causal_conv1d_cuda.causal_conv1d_bwd(x, weight, bias, dout, *args, **kwargs)

            def causal_conv1d_update_function(*args, **kwargs):
                return _causal_conv1d_cuda.causal_conv1d_update(*args, **kwargs)
        except Exception:
